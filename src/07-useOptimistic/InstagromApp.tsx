...
export const InstagromApp = () => {
  ...
  // muestra valores optimistas antes de que una accion sea resuelta
  // por ejemplo un peticion de un post, muestra en resultado en la ui antes de que se resuelva la peticion
  ...
  const handleAddComment = async (formData: FormData) => {
    ...
    startTransition(async () => {
      ...
      console.log("mesage save");
      //   setComments((prev) => [
      //     ...prev,
      //     { id: new Date().getTime(), text: messageText },
      //   ]);

      // codigo para revertir el proceso si falla el post
